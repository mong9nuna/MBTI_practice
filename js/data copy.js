/*
  ...
  * 
  'ENFP' 0 비글
  'INFP' 1 미어캣 
  군중속에서 티가 나지 않음 약간 왕관을 쓰고 있는데 군중속에 가려져 있는 느낌 괜츈
  'ENFJ' 2 앵무새
  의사소통 뛰어남
  'INFJ' 3 늑대
  눈치빠르고 나혼자 생각할 시간 꼭 필요
  'ENTP' 4 호랭이 
  'INTP' 5 부엉이
  'ENTJ' 6 사자
  'INTJ' 7 치타
  ...
  변화를 환영하고 새로운 접근방식에 잘 적응 한다
  따뜻하고 친절하며 상식적으로 판단한다
  존경하는 사람과 조직에 충성한다
  타인의 요구에 민감하며 실직적인 방식으로 사람을 잘 도운다
  실용적이고 현실적으로 행동 한다
